    ...
    actions: {
        async setCsrfToken(): Promise<string> {
            try {
                ...
                const response = await fetch('https://group39-web-apps-ec21653.apps.a.comp-teach.qmul.ac.uk/api/set-csrf-token/', {
                    method: 'GET',
                    credentials: 'include',
                    headers: {
        ...
        async login(email: string, password: string, router: Router | null = null) {
            try {
                ...
                const response = await fetch('https://group39-web-apps-ec21653.apps.a.comp-teach.qmul.ac.uk/api/login/', {
                    method: 'POST',
                    headers: {
        ...
        async logout(router: Router | null = null) {
            ...
            try {
                const csrfToken = await this.setCsrfToken()
                const response = await fetch('https://group39-web-apps-ec21653.apps.a.comp-teach.qmul.ac.uk/api/logout/', {
                    method: 'POST',
                    headers: {
                        'X-CSRFToken': csrfToken
                    },
