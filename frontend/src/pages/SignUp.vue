        ...
        <form @submit.prevent="handleSignup" class="space-y-6">
          ...
          <div class="space-y-2">
            ...
            <div class="flex flex-wrap gap-2 mb-2">
              ...
              >
                {{ hobby.name }}
                <button @click="removeHobby(hobby)" class="hover:text-destructive">x</button>
              </div>
            </div>
            ...
            <div class="flex gap-2">
              <Input v-model="newHobby" placeholder="Or type a new hobby" class="flex-1" />
              <Button type="button" @click="addNewHobby" variant="outline"> Add </Button>
            </div>
          </div>
...
<script setup lang="ts">
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      const response = await fetch(
        'https://group39-web-apps-ec22572.apps.a.comp-teach.qmul.ac.uk/api/signup/',
        {
          method: 'POST',
          headers: {
