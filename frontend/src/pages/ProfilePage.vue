...
<script setup lang="ts">
  ...
  const fetchHobbies = async (): Promise<void> => {
    try {
      ...
      const response = await fetch(
        'https://group39-web-apps-ec22572.apps.a.comp-teach.qmul.ac.uk/api/hobbies/',
        {
          credentials: 'include',
          headers: {
  ...
  const fetchUserProfile = async (): Promise<void> => {
    try {
      const csrfToken = await authStore.setCsrfToken()
      const response = await fetch(
        'https://group39-web-apps-ec22572.apps.a.comp-teach.qmul.ac.uk/api/profile/',
        {
          credentials: 'include',
          headers: {
            'X-CSRFToken': csrfToken
  ...
  const submitUpdateProfile = async (): Promise<void> => {
    try {
      ...
      const csrfToken = await authStore.setCsrfToken()
      const response = await fetch(
        'https://group39-web-apps-ec22572.apps.a.comp-teach.qmul.ac.uk/api/profile/update/',
        {
          method: 'POST',
          headers: {
  ...
  const submitUpdatePassword = async (): Promise<void> => {
    try {
      ...
      const csrfToken = await authStore.setCsrfToken()
      const response = await fetch(
        'https://group39-web-apps-ec22572.apps.a.comp-teach.qmul.ac.uk/api/profile/password/update/',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const fetchFriendRequests = async () => {
    try {
      ...
      const sentResponse = await fetch(
        'https://group39-web-apps-ec22572.apps.a.comp-teach.qmul.ac.uk/api/friend_requests/sent/',
        {
          credentials: 'include',
          headers: {
            'X-CSRFToken': csrfToken
      ...
      const receivedResponse = await fetch(
        'https://group39-web-apps-ec22572.apps.a.comp-teach.qmul.ac.uk/api/friend_requests/received/',
        {
          credentials: 'include',
          headers: {
            'X-CSRFToken': csrfToken
  ...
  const fetchFriends = async () => {
    try {
      const csrfToken = await authStore.setCsrfToken()
      const response = await fetch(
        'https://group39-web-apps-ec22572.apps.a.comp-teach.qmul.ac.uk/api/friends/',
        {
          credentials: 'include',
          headers: {
            'X-CSRFToken': csrfToken
  ...
  const handleFriendRequest = async (requestId: number, action: 'accept' | 'reject') => {
    try {
      const csrfToken = await authStore.setCsrfToken()
      const response = await fetch(
        `https://group39-web-apps-ec22572.apps.a.comp-teach.qmul.ac.uk/api/friend_requests/${action}/${requestId}/`,
        {
          method: 'POST',
          credentials: 'include',
          headers: {
