...
from .views import signup, user_login, user_logout, profile_api, update_profile_api, hobbies_api, add_hobby, main_spa, list_friends, list_received_requests, list_sent_requests, send_friend_request, accept_friend_request, reject_friend_request
...
urlpatterns = [
    ...
    path("api/profile/update/", update_profile_api, name="profile_api"),
